...
let rec print_proof (Proof(proof)) ~outx =
  let print =  Out_channel.output_string outx in 
...
let rec output_task_list  task_list ~outx = 
  let print =  Out_channel.output_string outx in
